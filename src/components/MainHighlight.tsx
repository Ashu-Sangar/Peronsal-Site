  ...
  <section className="w-full max-w-3xl mx-auto mt-6 animate-fade-in flex flex-col">
    <div className="relative rounded-lg overflow-hidden bg-card border border-border flex flex-col md:flex-row items-center">
      ...
      <div className="p-4 flex-1 flex flex-col justify-center">
        ...
        <a href="/resume/Ashu-Sangar-Resume.pdf" download className="inline-block mt-auto px-4 py-2 rounded bg-primary/80 text-primary-foreground font-semibold transition hover:bg-primary text-sm">Download CV</a>
      </div>
    </div>
  </section>
);
